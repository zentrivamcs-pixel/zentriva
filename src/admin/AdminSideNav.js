...
function AdminSideNav({ onLogout }) {
  return (
    <aside className="hidden md:flex h-screen w-64 fixed left-0 top-0 bg-primary-container shadow-md flex-col z-50">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="border-t border-outline-variant/20 pt-4 space-y-1">
          <a
            href="mailto:support@zentriva.org"
